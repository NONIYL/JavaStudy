...
public class C08_Objext {
	...
	/*
		 ...
		 - Object 클래스의 정의되어 있는 기본동작은 두 인스턴스가 같은 인스턴스인지를 
		   비교하게끔 만들어져있다
...
//		System.out.println(d1.equals(d2)); //값: false
		...
		//String은 hashCode()가 구현되어 있기 클래스이기 때문에
		//hashCode()메서드 실행시 메모리 주소대신 문자열 값에 기반한 숫자값이 생성된다
		String str1 = new String("abcd");
		String str2 = new String("hello" + "hihi.hi");
		String str3 = new String("hello" + "hihihi");
...
/*
 *   toString(), equals(), hashCode()를 모두 활용힐만한 
 *   적절한 클래스를 하나 설계해보세요
 */
