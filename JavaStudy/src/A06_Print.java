...
public class A06_Print {
	 ...
	 * 
	 * 2. %-숫자d : 숫자만큼 자릿수를 확보한 후 왼쩍 졍렬하여 출력한다
	 * 
	...
	public static void main(String[] args) {
		...
		System.out.printf("15의 8진수 형태: %o\n", 15);
		System.out.printf("15의 10진수 형태: %d\n", 15);
		System.out.printf("15의 16진수 형태: %x\n", 15);
		System.out.printf("15의 16진수 형태: %X\n", 15);
		...
		System.out.printf("%03d\t%03d\t%03d\t%03d\t%03d\n", 23, 94, 0, 25, 26);
		System.out.printf("%04d\t%04d\t%04d\t%04d\t%04d\n", 27, 33, 23, 68, 14);
		System.out.printf("%05d\t%05d\t%05d\t%05d\t%05d\n", 3, 3, 53, 1, 24);

		System.out.println("-----------------------------------------");

		System.out.printf("오늘 최고기온: %+6d℃\n", 23);
		System.out.printf("오늘 최저기온: %+6d℃\n", -24);
