	...
	/*
	 	# 정수 타입
	 		...
	 		- short	(2byte, 16bit)
	 		  ...
	 		  short타입 변수에 넣을 수 있는 정수의 범위는 -32,768 ~ +32,767 (65,536)
	 		  
	 		- char	(unsigned 2byte)
	 		
	 		  2^16(65,536)가지의 값을 표현할 수 있으나 부호가 없다 (양수만 표현한다)
	 		  char타입 변수에 넣을 수 있는 정수의 범위는 0 ~ +65,535 (65,536)
	 		
	 		- int	(4byte, 32bit)
	 		
	 		  2^32(4,294,967,296)가지의 값을 표현할 수 있다
	 		  int타입 변수에 넣을 수 있는 정수의 범위는 -2,147,483,648 ~ +2,147,483,647 (4,294,967,296)
	 		  
	 		- long	(8byte, 64bit)
	 		
	 		  2^64(18,446,744,073,709,551,616)가지의 값을 표현할 수 있다
	 		  long타입 변수에 넣을 수 있는 정수의 범위는 -9,223,372,036,854,775,808 ~ +9,223,372,036,854,775,807 (18,446,744,073,709,551,616)
