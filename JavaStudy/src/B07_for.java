...
public class B07_for {
	...
	/*
	 ...
	 # for문
	   ...
	   - 초기값 : for문을 처음 시작하면 단 한번 실행되는 곳 
	   	        주로 반복자(iterator)를 초기화 하는데에 사용된다
	...
	public static void main(String[] args) {
		...
		for (int i = 0; i < -1; ++i) {
		System.out.println("Hello, world! " + i); // 이처럼 나타낼 수 없는 값이면 출력도 안함
		...
		for (int i = -128; i < 128; ++i) {
			System.out.print(i + ", "); // -> 세로로 말고 가로로 출력 가능
		}
		System.out.println();
		 ...
		 */
		  int a = 10;
		  for (; a < 100;) {
			  System.out.println("프로그램 끅" + a++); // ++a: 11~100 a++: 11~99
		  }
