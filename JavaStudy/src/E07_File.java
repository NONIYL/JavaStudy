...
import java.io.IOException;
	...
	public class E07_File {
	   ...
	   public static void main(String[] args) {
	       ...
	       */
	      File ff1 = new File("C:/aiautomation_jsm/" 
	       + "java-workspace/JavaStudy/myfiles/memo/gugudan.txt");
	      File ff2 = new File("./myfiles/gugudan.txt");
	      ...
	      File fff2 = new File("myfiles/memo/gugudan.txt");
	      ...
	      try {
	         FileReader in = new FileReader(new File("myfiles/memo/gugudan.txt"));
