...
// Ctrl + F11 : 빌드 (컴파일 + 실행)
// F2 : 에러(빨간줄) 또는 경고(노란줄)가 있을 때 원인 해결책 띄우기
	...
	*/
	...
	public static void main(String[] args) {
		...
		*/
		...
		System.out.println("3313번 버스"); // ""사이에 적는 숫자는 문자열이다
		...
		// 2.문자 예시
		System.out.println((int)'가'); // '가' 44032
		System.out.println('감');
		System.out.println('배');
		System.out.println('귤');
		System.out.println('韓');
		System.out.println((int)'韓'); // '韓' 38867
		...
		// ※ 정수와 실수는 계산이 자유롭지만 문자열을 +로 이어붙이기만 가능하다
