...
//		@SuppressWarnings("unchecked")
		...
		fruits.add("strtrawberry");
		fruits.add("apple");
		fruits.add("orange");
		fruits.add("mandarin");
		
		//addFirst(data),addLst(data) 맨앞에/뒤에 더한다
		fruits.addFirst("watermelon");
		fruits.addLast("banana");
		
		//add(index, data) : 원하는 데이터 추가
		...
		fruits.removeFirst(); // == fruits.remove(); 
		fruits.removeLast();
		...
		//List와 Set은 Collection 인터페이스의 자식 인터페이스다
