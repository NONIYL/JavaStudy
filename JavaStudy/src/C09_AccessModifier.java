...
public class C09_AccessModifier extends myobj.C09_AcessModifierTest {
	...
	/*
	 	...
	 	- 다른 클래스에서 해당 자원을 사용하려고 할 때의 하용 범위를 설정한다
	 	...
	 	- protected : 다른 패키지의 다른 클래스에서 해당 클래스를 상속받는 경우에만 접근할 수 있다
	 	 			  일방적으로 사용하는 경우, 다른 패키지에서는 접근할 수 있다
	 ...
	 */
	//args : -a --i , ipconfig -all
	public static void main(String[] args) {
		for (int i = 0; i <args.length; ++i) {
			System.out.println("args? " + args[i]);
			
		}
		//현재 같은 패키지내에 존재하는 다른 클래스를 불러 사용하는경우
		...
		myobj.C09_AcessModifierTest test2 =
				new myobj.C09_AcessModifierTest();
