...
public class D06_collections {
	...
	public static void main(String[] args) {
		...
		//Arrays.fill(arr, value) : 배열의 모든 내용을(방을)하나의 값으로 채워버린다
		...
		//Collection.shuffle(List): 전달한 리스트의 순서를 섞어준다
		...
		System.out.println("판다가 몇번 나오나요? " + count);
