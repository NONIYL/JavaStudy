...
public class J04_Transcation {
	...
	public static void main(String[] args) {
		...
		try (
			...
			// insert = sql2, update = sql3
			String insert = "INSERT INTO sales(sale_date, sales) " + "VALUES(TO_CHAR(sysdate, 'YY/MM/DD'), ?)";
			
			String update = "UPDATE sales SET purchase = sales + ? " + "WHERE sale_date = TO_CHAR(sysdate, 'YY/MM/DD')";
