...
public class A01_Escape {
	...
	*/
	public static void main(String[] args) {
		...
		System.out.println("어서오세오! 환영합니다!!");
		...
		System.out.println("김철수\t010-1234-1234\t25");
		System.out.println("김민수\t010-1234-1234\t26");
		System.out.println("김영수\t010-1234-1234\t27");
		...
		// 자바에서는 문자 타입으로 작음따옴표를 사용하고 싶을 때만 사용하게 된다.
		System.out.println('\'');
