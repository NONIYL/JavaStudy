...
public static void main(String[] args) {
	...
	// map.comtainsValue(value): 해당 값이 있는지 여부를 반환
	...
	//putIfAbsent(Key,Value): 최초 추가하면 값을 추가하고,
	//이미 존재하는 값이 있다면 값을 수정하지 않고 값을 꺼낸다
	Integer value = scores.putIfAbsent("이주호", 330);
	//만약 다른 추가 말고 위의 신민수를 다시 적으면, 추가가 아닌 위에 적은 신민수의 값이 나옴
	...
	boolean result = scores.remove("신민수", 111);
