   ...
   */
	...
	public static void main(String[] args) {
		...
		/*
		 	...
		 	- 각 클래스마다의 perseXXX이 존재한다
		 */
		
		String value = "88";
		
		//parseXXX: 문자열을 해당 타입 값으로 변환
		//parseInt(str): 문자열을 int타입 값으로 만들어 반환
		int intValue = Integer.parseInt(value);
		
		//parseInt(str, redix): 문자열을 해당 진법으로 해석한 값을 만들어 반환
		...
		System.out.println("int타입은 몇 바이트? " + Integer.MIN_VALUE);
		System.out.println(Double.MAX_VALUE);
		System.out.println(Double.MIN_VALUE);
		
		//Character 타입의 기능들 : 글자인지 판단해주는 기능들
		...
		System.out.println("자바 변수로 활용할 수 있는 문자인가요? "
