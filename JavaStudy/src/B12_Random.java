...
public class B12_Random {
		...
		public static void main(String[] args) { 
			...
			// 랜덤 시드를 생성하면서 원하는 시드 번호를 전달할 수도있다
			// 전달하지 않는 경우 현재 시간이 시드 번호가 된다.
			Random ran1 =new Random(1000);
			Random ran2 =new Random(1002);
			Random ran3 =new Random(); // 현재 시간에 따라 랜덤 시트
			
//			System.out.println(System.currentTimeMillis() : 현재 시간을 밀리초로 알려준다
			System.out.println("현재 시간: " + System.currentTimeMillis());

			// 만들어진 랜덤 시드로부터 램덤 숫자 10개 꺼내기
			for (int i = 0; i < 10; ++i) {
			...
			for (int i = 0; i < 10; ++i) {
				System.out.println(ran3.nextInt(55)); // 0~99의 정수 ex> 1000  999
			}
			...
			for( int i = 0; i <30; ++i) {
				...
				// (31) = 0~30 , (30) + 31은 0~30이 아니라 31~60을 나타내는거임
